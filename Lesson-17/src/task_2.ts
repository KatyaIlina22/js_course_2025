...
constructor(firmName:string,registrationNumber:number){
...
class Product {
    ...
    firm:Firm;
    constructor( productName:string,unitOfMeasurement :string,numberOfProduct:number,firm:Firm){

...
class Car {
    ...
    constructor(initMark:string,initTankSize:number,initAvailableLiters:number,initNumberOfSeats:number,initNumberOfPassengers:number){
       this.mark = initMark
    ...
    refueling (numberOfLiters:number):number{
...
return this.availableLiters
    ...
    addPassengers (numberOfPassenger:number):number{
    ...
    passengerDisembarkation (numberOfPassenger:number):number{
this.numberOfPassengers-=numberOfPassenger
